...
<div class="logo">
    ...
    <div class="container top">
        ...
        <div class="texto">
            HadaPop es una empresa en continua evolución. Una compañía nueva, dinámica, que desea hacerte la vida más fácil.
        
    

    <div class="descripcion">
        Los clientes serán capaces de realizar transacciones de compra-venta de artículos de cualquier tipo, donde el usuario será el encargado de gestionar sus ventas y sus compras, teniendo la posibilidad de subir sus propios artículos e interactuar con otros usuarios. Nosotros proporcionamos la plataforma, la seguridad, privacidad de datos y la gestión del transporte de los productos.</div>
